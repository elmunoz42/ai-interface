  ...
  recipes: [
    {
      ...
      prompt: 'As an expert communicator, fix the grammar and spelling in the following text without additional commentary. Only return the corrected text.\n TEXT: \n',
    ...
    },
    {
      ...
      prompt: 'As an expert marketer, create a social media post based on the following subject matter.\nCONTENT: \n',
      modelId: 'gpt-4',
      temperature: 0.7,
      maxTokens: 400,
      isEditing: false
    },
    {
      ...
      prompt: 'As a creative brainstorming partner, help me generate ideas for the following topic.\nTOPIC: \n',
      modelId: 'gpt-4',
      temperature: 1.0,
      maxTokens: 500,
      isEditing: false
    },
    {
      ...
      prompt: 'As a summarization expert, please provide a concise summary of the following content.\nCONTENT: \n',
    ...
    },
    {
      ...
      prompt: 'As a research assistant, provide information from our knowledge base on the following topic.\nTOPIC:\n',
      modelId: 'rag-faiss',
      temperature: 0.4,
      maxTokens: 300,
      isEditing: false
