...
load_dotenv('.env.local')  # Load .env.local file (overrides .env)
...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-g2^*ultpg0raa-wo8plg32=++g%%9ibxv0p@+&n9(2s%mn&wgi')
